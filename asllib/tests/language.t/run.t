...
Test Ijdcc.asl:
  ...
  ASL Typing error: Cannot extract from bitvector of length 5 slices 7+:4.
  [1]
...
Test Rccvd.asl:
  $ aslref Rccvd.asl
  File Rccvd.asl, line 5, character 0 to line 16, character 3:
  ASL Typing error: explicit parameter "parm" does not have a corresponding
    defining argument
  [1]
